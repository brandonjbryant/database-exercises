...
#1. Alselm Cappaello #2. Utz Mandell #3. Bouchung Schreiter #4. Baocai Kushner #5. Petter Stroustrup
SELECT *
FROM employees
...
#1. Christophe Baca #2 Moie Birsak #3 Chikako Ibel #4. Shounak Jansen #5. Zhigen Boissier
SELECT *
FROM employees
WHERE hire_date LIKE '199%'
AND birth_date LIKE '%-12-25'
...
#Limit sets the amount of reults that will be displayed(per page). OFFSET sets the page number based on how many results are skipped.
#EXAMPLE: LIMIT 10 OFFSET 50  will result in 5 pages 